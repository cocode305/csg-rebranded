...
const toggle = document.querySelectorAll('.nav-links');

// Function for toggling the navlinks (Elisha's change);
...
//I commented out the set of code below because they don't seem to be doing what you intend for them to do and they're giving issues in the consle n returning as null.
